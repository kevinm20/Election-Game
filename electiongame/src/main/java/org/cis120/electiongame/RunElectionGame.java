 ...
 */
public class RunElectionGame implements Runnable {
    ...
    public void run() {
        ...
        play.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (election.getPlayer1Card() == null || election.getPinned1().get(0) == null
                        || election.getPinned1().get(1) == null) {
        ...
        undo.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (election.getPlayer1Card() == null && election.getPinned1().get(0) == null
                    ...
                    if (election.getPlayer1Card() != null) {
                        election.getPlayer1().add(election.getPlayer1Card());
                    }

                    if (election.getPinned1().get(0) != null) {
                        election.getPlayer1().add(election.getPinned1().get(0));
                    }

                    if (election.getPinned1().get(1) != null) {
                        election.getPlayer1().add(election.getPinned1().get(1));
                    }
        ...
        String difficulty = JOptionPane.showInputDialog(
                "Choose the difficulty of the AI. Enter \"Impossible\", \"Hard\", \"Medium\","
            ...
            for (President curr : hand) {
                ...
                usercd.addMouseListener(new MouseAdapter() {
                    public void mouseReleased(MouseEvent e) {
                        ...
                        election.player1PlayCard(curr);
                        election.getPlayer1().place(curr);
                        board.draw();
                        paintCards();
                        repaint();
                    }
    ...
    public class UserPolicies extends JPanel {
        ...
        public UserPolicies() {
            ...
            this.hand = election.userPolicies();
            paintCards();
            ...
            for (Policy curr : hand) {
                ...
                usercd.addMouseListener(new MouseAdapter() {
                    public void mouseReleased(MouseEvent e) {
                        ...
                        if ((election.getPinned1().get(0) != null
                                && election.getPinned1().get(0).sameCategory(curr))
                                || election.getPinned1().get(0) == null
                                        && election.getPinned1().get(1) != null
                                        && election.getPinned1().get(1).sameCategory(curr)) {
                            JOptionPane.showMessageDialog(
                                    board,
                        ...
                        } else if (election.getPinned1().get(0) == null) {
                            election.pinUserPolicy(election.getPlayer1().place(curr), 0);
                            board.draw();
                            paintCards();
                        } else if (election.getPinned1().get(1) == null) {
                            election.pinUserPolicy(election.getPlayer1().place(curr), 1);
                            board.draw();
                            paintCards();
                        } else {
                            Policy pol = election.pinUserPolicy(election.getPlayer1().place(curr));
                            if (pol != null) {
                                election.getPlayer1().add(pol);
                            }
                            board.draw();
                            paintCards();
                        }
    ...
    public class GameBoard extends JPanel {
        ...
        public void draw() {
            ...
            for (int i = 0; i < 2; i++) {
                int pos = i;
                Policy curr = election.getPinned1().get(i);
                if (curr != null) {
                    ...
                    label.addMouseListener(new MouseAdapter() {
                        public void mouseReleased(MouseEvent e) {
                            election.getPlayer1().add(election.pinUserPolicy(null, pos));
                            draw();
                            up.paintCards();
                        }
                    });
